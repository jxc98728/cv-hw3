...
def stochastic_depth_resnet18(num_class):
    """ return a ResNet 18 object
    """
    return StochasticDepthResNet(StochasticDepthBasicBlock, [2, 2, 2, 2], num_class=num_class)

def stochastic_depth_resnet34(num_class):
    """ return a ResNet 34 object
    """
    return StochasticDepthResNet(StochasticDepthBasicBlock, [3, 4, 6, 3], num_class=num_class)

def stochastic_depth_resnet50(num_class):

    """ return a ResNet 50 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 4, 6, 3], num_class=num_class)

def stochastic_depth_resnet101(num_class):
    """ return a ResNet 101 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 4, 23, 3], num_class=num_class)

def stochastic_depth_resnet152(num_class):
    """ return a ResNet 152 object
    """
    return StochasticDepthResNet(StochasticDepthBottleNeck, [3, 8, 36, 3], num_class=num_class)
