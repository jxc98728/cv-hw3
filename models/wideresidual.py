...
class WideResNet(nn.Module):
    def __init__(self, num_class, block, depth=50, widen_factor=1):
        super().__init__()
        ...
        self.linear = nn.Linear(64 * k, num_class)
...
def wideresnet(num_class, depth=40, widen_factor=10):
    return WideResNet(100, WideBasic, depth=depth, widen_factor=widen_factor, num_class=num_class)